...
watch(() => form.type, (newType) => {
    ...
    if ((newType === 'bill' || newType === 'financing') && !props.purchase) {
        form.notify_due = true
    }
})
...
<template>
    ...
    >
        ...
        >
            ...
            />
            <p
                v-if="form.errors.installments_total"
                class="text-sm text-destructive"
            >
                {{ form.errors.installments_total }}
            </p>
        </div>
        ...
        <div
            v-if="!isCreditCard && !form.is_recurring"
        ...
        >
            ...
            <Label
                ...
                @click="form.mark_as_paid = !form.mark_as_paid"
            >
                Marcar como pago
            </Label>
        </div>
